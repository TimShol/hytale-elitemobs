...
Categories can be managed through the [Admin UI](/config/admin-ui) under Global Config &rarr; Weapon Categories.

![Weapon Categories](../images/admin-ui-weapon-categories.png)
...
![Armor Categories](../images/admin-ui-armor-categories.png)
...
These settings are editable through the [Admin UI](/config/admin-ui) under Global Config &rarr; Rarity & Tiers.
