...
`effects.yml` controls the passive entity effects applied to elites. Effects are ongoing buffs or debuffs with configurable per-tier enablement and visual particle systems. The system is generic — new effects can be added by config entry alone.
...
- **Visual:** Particle effect on the elite
...
![Entity Effects Editor](../images/admin-ui-entity-effects.png)
