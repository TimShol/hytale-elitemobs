...
**Tip:** The summon ability is gated by default to undead mobs plus Goblin_Duke and Trork_Shaman (`roleMustContain: ["skeleton", "zombie", "wraith", "Goblin_Duke", "Trork_Shaman"]`). To allow other mob types to summon, add them to both `roleMustContain` in the gate and add an appropriate prefix to `roleIdentifiers`.
