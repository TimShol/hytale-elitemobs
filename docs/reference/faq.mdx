...
RPGMobs has 10 abilities, but not every mob gets all of them. Abilities are linked to specific mob rules with per-tier toggles and weapon category gates. Additionally, T4+ elites are assigned a combat personality (Aggressive, Tactical, Strategic, Berserker) that filters which abilities they receive  -  each personality gets a coherent set of 3-6 abilities. T1-T3 elites get a limited set: T1 gets Dodge Roll only, T2 adds Multi Slash, T3 adds Enrage.
