...
*   **CAE Combat AI:** Faction-specific combat styles (Disciplined, Berserker, Tactical, Chaotic) with per-tier behavior escalation  -  shield guard, BackOff, health retreat, group observe, and flanking. Per-weapon attack chains with correct animations and sounds. Code-side reactive parry system.
