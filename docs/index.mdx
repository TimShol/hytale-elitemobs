...
*   **10 Combat Abilities:** Charge Leap, Heal Leap, Summon, Dodge Roll, Multi Slash (Short/Medium/Long), War Cry, Enrage, and Volley  -  each with weapon-specific animations and per-mob-rule gating.
*   **Combat Intelligence:** T4-T5 elites analyze targets, adopt combat personalities (Aggressive/Tactical/Strategic/Berserker), and coordinate group roles.
