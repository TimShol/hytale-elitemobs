...
/**
 * Event record fired after health, damage, and model scaling have been applied to an RPG mob.
 *
 ...
 *
 * @param mobRef           the entity reference of the RPG mob that was scaled
