...
import com.frotty27.rpgmobs.api.events.RPGMobsAbilityStartedEvent;

/**
 * Enumeration of ability types available to RPG Mobs.
 *
 * <p>Each constant represents a distinct ability that an RPG mob can perform.
 * The string-based {@linkplain #getId() ID} of each type matches the ability
 * identifier used in events such as
 * {@link RPGMobsAbilityStartedEvent}.</p>
 *
 * @since 1.1.0
 */
public enum AbilityType {
    ...
    /**
     * A summoning ability that spawns undead minions to fight alongside the RPG mob.
     */
    SUMMON_UNDEAD,
