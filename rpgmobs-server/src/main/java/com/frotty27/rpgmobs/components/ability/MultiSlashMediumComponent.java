...
public final class MultiSlashMediumComponent implements AbilityEnabledComponent {
    ...
    public static final BuilderCodec<MultiSlashMediumComponent> CODEC = BuilderCodec.builder(MultiSlashMediumComponent.class,
            MultiSlashMediumComponent::new
    ...
    public MultiSlashMediumComponent() {
    ...
    public Component<EntityStore> clone() {
        MultiSlashMediumComponent c = new MultiSlashMediumComponent();
