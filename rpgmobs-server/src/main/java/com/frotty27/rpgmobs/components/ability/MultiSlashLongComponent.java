...
public final class MultiSlashLongComponent implements AbilityEnabledComponent {
    ...
    public static final BuilderCodec<MultiSlashLongComponent> CODEC = BuilderCodec.builder(MultiSlashLongComponent.class,
            MultiSlashLongComponent::new
    ...
    public MultiSlashLongComponent() {
    ...
    public Component<EntityStore> clone() {
        MultiSlashLongComponent c = new MultiSlashLongComponent();
