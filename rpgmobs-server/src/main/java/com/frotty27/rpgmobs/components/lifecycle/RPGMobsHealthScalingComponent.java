...
public final class RPGMobsHealthScalingComponent implements Component<EntityStore> {
    ...
    public static final BuilderCodec<RPGMobsHealthScalingComponent> CODEC = BuilderCodec.builder(
            RPGMobsHealthScalingComponent.class,
            RPGMobsHealthScalingComponent::new
    ).append(K_HEALTH_APPLIED, (c, v) -> c.healthApplied = v, c -> c.healthApplied).add().append(K_APPLIED_HEALTH_MULT,
            ...
            K_HEALTH_FINALIZED,
            (c, v) -> c.healthFinalized = v,
            c -> c.healthFinalized
    ).add().build();

    public RPGMobsHealthScalingComponent() {
    }

    @Override
    public Component<EntityStore> clone() {
        RPGMobsHealthScalingComponent c = new RPGMobsHealthScalingComponent();
