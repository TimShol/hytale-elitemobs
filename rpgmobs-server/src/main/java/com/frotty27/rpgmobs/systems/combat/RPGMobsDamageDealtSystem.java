...
import static com.frotty27.rpgmobs.utils.StringHelpers.safeRoleName;

public final class RPGMobsDamageDealtSystem extends DamageEventSystem {
    ...
    public void handle(int entityIndex, @NonNull ArchetypeChunk<EntityStore> archetypeChunk,
        ...
        try {
            ...
            throw new RPGMobsSystemException("Error in RPGMobsDamageDealtSystem", e);
        }
    }
    ...
    private static String classifyAttackerKind(Store<EntityStore> entityStore, Ref<EntityStore> attackerEntityRef) {
        ...
        if (entityStore.getComponent(attackerEntityRef, PROJECTILE_COMPONENT_TYPE) != null)
            return ATTACKER_KIND_PROJECTILE;
