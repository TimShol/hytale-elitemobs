...
/**
 * Event fired when an elite mob's ability is interrupted before it completes.
 *
 ...
 * @since 1.1.0
 */
public final class EliteMobAbilityInterruptedEvent {
     ...
     *
     * @param entityRef the entity reference of the elite mob whose ability was interrupted
     ...
     */
    public EliteMobAbilityInterruptedEvent(Ref<EntityStore> entityRef, String abilityId, int tierIndex, String reason) {
    ...
    /**
     * Returns the entity reference of the elite mob whose ability was interrupted.
     *
